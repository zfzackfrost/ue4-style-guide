...
Gamemakin LLC (and ZGW) is not a lawyer, but please don't introduce illegal actions and behavior to a project, including but not limited to:
...
| Prefab                     | P_       |         | Prefabs support is provided by third-party plugins. |
